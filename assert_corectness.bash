...
./orthAgogue -i empirical_tests/goodProteins.blast -nn -O empirical_tests/turbo/gp_file/ -bho -c 1; 
#./orthAgogue -i empirical_tests/goodProteins.blast -nn -O empirical_tests/turbo/gp_file/ -bho -c 1 -pd; 
