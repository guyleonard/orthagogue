  ...
  **/
  ...
  static void throw_warning(warnings_t type, const int line, const char *file, const char *function,const char *message) {
    ...
    */
    ...
    else if(type == software_dependencies) fprintf(stderr, "software_dependency-error!!\t%s. If this error was not as expected, please contact the developer at oekseth@gmail.com adding the following information: Error generated at line %d in file %s for method %s\n", message, line, file, function);
